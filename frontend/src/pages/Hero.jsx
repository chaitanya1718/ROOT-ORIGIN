...
const bgAssets = {
  milk: [
    { id: 1, src: `${milksm}`, x: -200, y: -150, size: 120, depth: 0.2, opacity: 0.25 },
    { id: 2, src: `${milksm}`, x: 200, y: -80, size: 110, depth: 0.4, opacity: 0.3 },
    { id: 3, src: `${milksm}`, x: -180, y: 50, size: 80, depth: 0.3, opacity: 0.3 },
  ],
  juice: [
    { id: 1, src: `${sweetsm}`, x: -150, y: -100, size: 130, depth: 0.3, opacity: 0.3 },
    { id: 2, src: `${sweetsm}`, x: 200, y: -50, size: 80, depth: 0.5, opacity: 0.25 },
    { id: 3, src: `${sweetsm}`, x: -180, y: 50, size: 80, depth: 0.3, opacity: 0.3 },
  ],
  coffee: [
    { id: 1, src: `${laysm}`, x: -200, y: -80, size: 120, depth: 0.2, opacity: 0.25 },
    { id: 2, src: `${laysm}`, x: 260, y: -80, size: 90, depth: 0.4, opacity: 0.3 },
    { id: 3, src: `${laysm}`, x: 200, y: 80, size: 90, depth: 0.4, opacity: 0.3 },
  ],
  iceCreams: [
    { id: 1, src: `${icesm}`, x: -200, y: -80, size: 120, depth: 0.2, opacity: 0.25 },
    { id: 2, src: `${icesm}`, x: 260, y: -80, size: 90, depth: 0.4, opacity: 0.3 },
    { id: 3, src: `${icesm}`, x: 200, y: 80, size: 110, depth: 0.4, opacity: 0.3 },
  ],
};
...
const feedbacks = [
  {
    id: 1,
    name: "Sumanth",
    photo: "https://png.pngtree.com/png-vector/20231019/ourmid/pngtree-user-profile-avatar-png-image_10211467.png",
    rating: 4,
  ...
  { id: 4, name: "Rakesh", photo: `${rakesh}`, rating: 4, message: "Very smooth experience and great customer support." },
  { id: 5, name: "Deepak", photo: `${deepak}`, rating: 5, message: "I love Kaju Katli, the quality is awesome." },
];
    ...
    <div>
      ...
      >
        ...
        <div className="absolute bottom-30 flex gap-4 z-20">
          <Link to="/register">
            <button className="relative overflow-hidden text-white bg-linear-to-tr from-cyan-800 to-teal-400 px-4 py-2 rounded-2xl text-cyan-800 transition-transform duration-300 ease-in-out hover:scale-110 hover:text-white shine-btn">
              Get started
            </button>
          </Link>
        </div>
      ...
      <div className="flex justify-center">
        <h1 className="text-3xl border-b-2 border-b-cyan-800 px-4">Our Services</h1>
      </div>
      ...
      <div className="features flex justify-around items-center py-8 flex-wrap gap-6">
        <div className="service-card bg-cyan-300 w-80 h-60 rounded-xl p-5 flex flex-col items-center text-center">
          ...
          <p className="text-sm mt-2 text-cyan-900">
            Milk and curd delivered daily to your doorstep with guaranteed freshness.
          </p>
        </div>
        ...
        <div className="service-card bg-cyan-300 w-80 h-60 rounded-xl p-5 flex flex-col items-center text-center">
          ...
          <p className="text-sm mt-2 text-cyan-900">
            Indulge in rich, creamy ice creams made from pure dairy and natural ingredients.
          </p>
        </div>
        ...
        <div className="service-card bg-cyan-300 w-80 h-60 rounded-xl p-5 flex flex-col items-center text-center">
          ...
          <p className="text-sm mt-2 text-cyan-900">
            Subscribe once and receive fresh nutrition essentials every day, hassle-free.
          </p>
        </div>
      </div>

      <div className="flex justify-center">
        <h1 className="text-3xl border-b-2 border-b-cyan-800 px-4 mb-8">Hear from our customers</h1>
      </div>
        ...
        <div className="carousel-sec py-2">
          {[...feedbacks, ...feedbacks].map((item, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-2 line-clamp-3">{item.message}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="footer mt-8 min-h-[50vh] bg-cyan-950 text-white py-4">
        <div className="flex justify-around">
          <div>
            <h1 className="text-2xl border-b border-b-white pr-2">Quick links</h1>
          ...
          <div>
            <h1 className="text-2xl border-b border-b-white pr-2">Social media</h1>
